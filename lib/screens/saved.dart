  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: favorites.isEmpty
          ? const Center(child: Text("There is not list yet"))
          : ListView.builder(
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ClipRRect(
                            borderRadius: BorderRadius.circular(10),
                            child: Image.network(favorites[index]["gif"] ?? "",
                          ...
                          Expanded(
                            child: Center(
                              child: Text(
                                ...
                                style:
                                    const TextStyle(color: blue, fontSize: 15),
                              ),
                            ),
                          ),
                          IconButton(
                            ...
                            icon:
                                provider.isExist(favorites[index]["name"] ?? "")
